...
| **M3.5** ciclo de vida dos terminais e do WebGL ⬥ | `docs/specs/m3.5-terminal-lifecycle.md` | Recurso escasso (~16 contextos no Chromium) com montagem e desmontagem constantes. Vazar contexto não quebra no teste, quebra na vigésima troca de aba. Escrever a spec mostrou um problema maior: o layout do React remonta o terminal a cada split ou maximizar, e o terminal remontado nasce em branco. Os terminais saíram da árvore do React. |
